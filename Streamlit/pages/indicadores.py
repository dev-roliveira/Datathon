...
def show_indicadores():
    with st.expander("Indicador de Autoavaliação - IAA"):
        ...
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IAA_2020_2022.csv', sep=';')
        ...
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IAA_2021_2022.csv', sep=';')
        fig = px.bar(data_frame=dt, x=dt['TIPO'], y=dt['TOTAL'])
        st.plotly_chart(fig)
        ...
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IAA_2020_2021.csv', sep=';')
        fig = px.bar(data_frame=dt, x=dt['TIPO'], y=dt['TOTAL'])
        st.plotly_chart(fig)
    ...
    with st.expander("Indicador Psicossocial - IPS"):
        ...
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IPS_2020_2022.csv', sep=';')
        fig = px.bar(data_frame=dt, x=dt['TIPO'], y=dt['TOTAL'])
        st.plotly_chart(fig)
        ...
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IPS_2021_2022.csv', sep=';')
        fig = px.bar(data_frame=dt, x=dt['TIPO'], y=dt['TOTAL'])
        st.plotly_chart(fig)
        ...
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IPS_2020_2021.csv', sep=';')
        fig = px.bar(data_frame=dt, x=dt['TIPO'], y=dt['TOTAL'])
        st.plotly_chart(fig)
    ...
    with st.expander("Indicador Psicopedagógico - IPP"):
        ...
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IPP_2020_2022.csv', sep=';')
        fig = px.bar(data_frame=dt, x=dt['TIPO'], y=dt['TOTAL'])
        st.plotly_chart(fig)
        ...
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IPP_2021_2022.csv', sep=';')
        fig = px.bar(data_frame=dt, x=dt['TIPO'], y=dt['TOTAL'])
        st.plotly_chart(fig)
        ...
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IPP_2020_2021.csv', sep=';')
        fig = px.bar(data_frame=dt, x=dt['TIPO'], y=dt['TOTAL'])
        st.plotly_chart(fig)
    ...
    with st.expander("Indicador de Engajamento - IEG"):
        ...
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IEG_2020_2022.csv', sep=';')
        fig = px.bar(data_frame=dt, x=dt['TIPO'], y=dt['TOTAL'])
        st.plotly_chart(fig)
        ...
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IEG_2021_2022.csv', sep=';')
        fig = px.bar(data_frame=dt, x=dt['TIPO'], y=dt['TOTAL'])
        st.plotly_chart(fig)
        ...
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IEG_2020_2021.csv', sep=';')
        fig = px.bar(data_frame=dt, x=dt['TIPO'], y=dt['TOTAL'])
        st.plotly_chart(fig)
    ...
    with st.expander("Indicador de Desempenho Acadêmico - IDA"):
        ...
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IDA_2020_2022.csv', sep=';')
        fig = px.bar(data_frame=dt, x=dt['TIPO'], y=dt['TOTAL'])
        st.plotly_chart(fig)
        ...
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IDA_2021_2022.csv', sep=';')
        fig = px.bar(data_frame=dt, x=dt['TIPO'], y=dt['TOTAL'])
        st.plotly_chart(fig)
        ...
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IDA_2020_2021.csv', sep=';')
        fig = px.bar(data_frame=dt, x=dt['TIPO'], y=dt['TOTAL'])
        st.plotly_chart(fig)
    ...
    with st.expander("Indicador do Ponto de Virada - IPV"):
        ...
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IPV_2020.csv', sep=';')
        ...
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IPV_2021.csv', sep=';')
        fig = px.bar(data_frame=dt, x=dt['PONTO_VIRADA_2021'], y=dt['TOTAL'])
        st.plotly_chart(fig)

        st.write("")
        st.write("E a mesma porcentagem se reflete no ano de 2022.")    
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IPV_2022.csv', sep=';')
    ...
    with st.expander("Indicador de Adequação de Nível - IAN"):
        ...
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IAN_2020_2022.csv', sep=';')
        fig = px.bar(data_frame=dt, x=dt['TIPO'], y=dt['TOTAL'])
        st.plotly_chart(fig)

        st.write("")                
        st.write("Enquanto, os alunos que participaram nos anos de 2021 e 2022, 60,14% tiveram a defasagem aumentada.")
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IAN_2021_2022.csv', sep=';')
        fig = px.bar(data_frame=dt, x=dt['TIPO'], y=dt['TOTAL'])
        st.plotly_chart(fig)

        st.write("")
        st.write("O mesmo ocorre com os alunos que participaram somente nos anos de 2020 e 2021, onde 75,52% aumentaram a defasagem.")    
        dt = pd.read_csv('https://raw.githubusercontent.com/dev-roliveira/Datathon/master/Streamlit/IAN_2020_2021.csv', sep=';')
        fig = px.bar(data_frame=dt, x=dt['TIPO'], y=dt['TOTAL'])
        st.plotly_chart(fig)
